                                ...
                                <h2 className="heading-section">Login </h2>
                                    ...
                                    <Form onSubmit={handleSubmit} noValidate validated={validated} className="login-form">
                                        ...
                                        <Form.Group as={Col} md="4" controlId="exampleForm.ControlInput1" className="col-12 col-lg-12 my-2 mb-3 d-flex">
                                            ...
                                            {EmailError ? <label className="error-msg">{EmailError}</label> : null}
                                        </Form.Group>
                                        <Form.Group as={Col} md="3" controlId="validationCustom01" className="col-12 col-lg-12 my-2 mb-3 d-flex">
                                        ...
                                        {error ? <label className="error-msg mt-0">{error}</label> : null}
                                        <div className="form-group">
                                            <button className="form-control login-form-control btn btn-login btn-primary rounded submit px-3" type="submit">Login</button>
                                        </div>
                                        <div className="text-center justify-content-center">
              <p className="small fw-bold mt-1 pt-1 mb-0">
            Don't have an account? <Link className="btn-primary" style={{ textDecoration: "none", cursor: "pointer" }} href='/signup'>Register here</Link>
          </p>
          </div>
                                    </Form>
                                </div>
